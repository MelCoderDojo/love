In this tutorial, we're going to start drawing things on the screen. We'll also start moving with keys.
...
Let's get moving! Now, we finally put `love.update` to work.
